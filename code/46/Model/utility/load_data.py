...
class Data(object):
    def __init__(self, args, path):
        ...
        # train_data is [[0, 1], [0, 2], [0, 3]]
        # train_user_dict is {0:[1, 2, 3]}
        ...
        # kg_data  直接将知识图谱转为三元组 (2557746, 3)
        #
        # kg[head].append((tail, relation))  ->  kg_dict
        #
        # rd[relation].append((head, tail))  ->  relation_dict
        #
        # kg_dict, relation_dict 没看到哪里有使用
        #
    ...
    def _load_ratings(self, file_name):
        ...
        # for example  0 1 2 3
        # inter_mat is [[0, 1], [0, 2], [0, 3]]
        # user_dict is {0:[1, 2, 3]}
